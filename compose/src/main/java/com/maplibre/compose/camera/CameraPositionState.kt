 ...
 * @property FOLLOW_WITH_BEARING The camera follows the user location and rotates to match the
 *   user's course.
 */
@Parcelize
 ...
 *   [CameraPosition.animationDurationMs] milliseconds.
 */
@Parcelize
enum class CameraMotionType : Parcelable {
  INSTANT,
  EASE,
  FLY
}
