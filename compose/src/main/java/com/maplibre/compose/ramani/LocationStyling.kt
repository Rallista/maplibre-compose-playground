...
class LocationStyling(
    ...
    class Builder {
        ...
        fun enablePulseFade(enablePulseFade: Boolean?) = apply { this.enablePulseFade = enablePulseFade }
        fun pulseColor(@ColorInt pulseColor: Int?) = apply { this.pulseColor = pulseColor }

        fun build() = LocationStyling(accuracyAlpha, accuracyColor, enablePulse, enablePulseFade, pulseColor)
    }
