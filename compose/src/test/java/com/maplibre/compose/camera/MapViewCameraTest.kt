...
class MapViewCameraTest {
  ...
  fun `test MapViewCamera centered equality`() {
    ...
    assertNotEquals(
        MapViewCamera.Centered(0.0, 0.0), MapViewCamera.TrackingUserLocationWithBearing())
  }
  ...
  fun `test MapViewCamera tracking user location equality`() {
    ...
    assertNotEquals(
        MapViewCamera.TrackingUserLocation(), MapViewCamera.TrackingUserLocationWithBearing())
  ...
  fun `test MapViewCamera tracking user location with bearing equality`() {
    assertEquals(
        MapViewCamera.TrackingUserLocationWithBearing(),
        MapViewCamera.TrackingUserLocationWithBearing())
    assertNotEquals(
        MapViewCamera.TrackingUserLocationWithBearing(), MapViewCamera.TrackingUserLocation())
    assertNotEquals(
        MapViewCamera.TrackingUserLocationWithBearing(), MapViewCamera.Centered(0.0, 0.0))
  }
  ...
  fun `test MapViewCamera default hashCode`() {
    ...
    assertNotEquals(
        MapViewCamera.Default.hashCode(), MapViewCamera.TrackingUserLocation().hashCode())
    assertNotEquals(
        MapViewCamera.Default.hashCode(),
        MapViewCamera.TrackingUserLocationWithBearing().hashCode())
  }

  @Test
  fun `test MapViewCamera centered hashCode`() {
    assertEquals(
        MapViewCamera.Centered(0.0, 0.0).hashCode(), MapViewCamera.Centered(0.0, 0.0).hashCode())
    assertNotEquals(
        MapViewCamera.Centered(0.0, 0.0).hashCode(), MapViewCamera.Centered(0.0, 1.0).hashCode())
    assertNotEquals(
        MapViewCamera.Centered(0.0, 0.0).hashCode(),
        MapViewCamera.TrackingUserLocation().hashCode())
    assertNotEquals(
        MapViewCamera.Centered(0.0, 0.0).hashCode(),
        MapViewCamera.TrackingUserLocationWithBearing().hashCode())
  }
